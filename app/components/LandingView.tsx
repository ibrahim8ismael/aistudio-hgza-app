  ...
  return (
    <div className="min-h-screen bg-[#0d0e11] flex flex-col relative font-sans text-on-surface">
       ...
       <header className="w-full flex justify-between items-center p-6 md:px-12 max-w-7xl mx-auto z-20">
           <div className="font-headline font-black italic text-[#E9C400] text-2xl tracking-tight">
             HGZA
           </div>
           <button 
                ...
                >
                   ...
                   <div className="p-8 pb-10 text-center">
                       ...
                       <div className="space-y-3">
                         <button 
                           onClick={onSignIn}
                           className="w-full bg-white hover:bg-gray-100 text-black font-label font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-3 text-sm"
                         >
                         ...
                         <button 
                           onClick={onSignIn}
                           className="w-full bg-[#1877F2] hover:bg-[#1877F2]/90 text-white font-label font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-3 text-sm"
                         >
